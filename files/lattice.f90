!$Id: lattice.f90,v 1.2 2003/04/03 07:15:31 nuclear Exp $
module lattice
   implicit none
...
!
    ...
    real(kind=r8), dimension(3,1) :: basis = &
       reshape((/0.25d0, 0.25d0, 0.25d0/),(/3,1/))
...
!
    ...
    real(kind=r8), dimension(3,2) :: basis = &
       reshape((/0.25d0, 0.25d0, 0.25d0, 0.75d0, 0.75d0, 0.75d0/) &
       ,(/3,2/))
...
!
     ...
     real(kind=r8), dimension(3,4) :: basis = &
        reshape((/0.25d0, 0.25d0, 0.25d0, 0.75d0, 0.75d0, 0.25d0, &
        0.75d0, 0.25d0, 0.75d0, 0.25d0, 0.75d0, 0.75d0/),(/3,4/))
...
!
   ...
   real(kind=r8) :: scale
   integer(kind=i4) :: nlat,i,i1,i2,i3,ib,nbasis
   nbasis=size(basis)/3
   scale=1.0_r8/nside
   i=0
   do i1=0,nside-1
...
!
   ...
   real(kind=r8) :: en
   en=npart
   nsidesc=nint(en**(1.d0/3.d0))
   if (nsidesc**3.lt.npart) nsidesc=nsidesc+1
   nsc=nsidesc**3
   nsidebcc=nint((en*0.5d0)**(1.d0/3.d0))
   if (nsidebcc**3*2.lt.npart) nsidebcc=nsidebcc+1
   nbcc=nsidebcc**3*2
   nsidefcc=nint((en*0.25d0)**(1.d0/3.d0))
